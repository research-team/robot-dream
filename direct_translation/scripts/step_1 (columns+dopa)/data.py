...
L2_tuple = ({k_name: 'L2 [Glu]',    k_NN: 10},
            {k_name: 'L2 [GABA]',   k_NN: 40},
            )

L3_tuple = ({k_name: 'L3 [Glu]',    k_NN: 10}, )

L4_tuple = ({k_name: 'L4 [Glu]',    k_NN: 5},
            {k_name: 'L4 [GABA]',   k_NN: 20}
            )

L5_tuple = ({k_name: 'L5 [Glu]',    k_NN: 10},
            {k_name: 'L5 [GABA]',   k_NN: 20}
            )

L6_tuple = ({k_name: 'L6 [Glu]',    k_NN: 10},
            {k_name: 'L6 [GABA]',   k_NN: 20}
            )
