...
#define nrn_init _nrn_init__AtP_4
#define _nrn_initial _nrn_initial__AtP_4
#define nrn_cur _nrn_cur__AtP_4
#define _nrn_current _nrn_current__AtP_4
#define nrn_jacob _nrn_jacob__AtP_4
#define nrn_state _nrn_state__AtP_4
#define _net_receive _net_receive__AtP_4 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 AtP_4 /Users/sulgod/rd/Nociception/x86_64/atp4.mod\n");
