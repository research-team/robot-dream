...
#define nrn_init _nrn_init__AtP_42
#define _nrn_initial _nrn_initial__AtP_42
#define nrn_cur _nrn_cur__AtP_42
#define _nrn_current _nrn_current__AtP_42
#define nrn_jacob _nrn_jacob__AtP_42
#define nrn_state _nrn_state__AtP_42
#define _net_receive _net_receive__AtP_42 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 AtP_42 /Users/sulgod/rd/Nociception/cfiber/x86_64/atp42.mod\n");
...
{
 {
   ...
   if ( t > tx1 ) {
     ...
     atp = ( 2.0 * c0cleft * PI * a * alpha * rPSD * rPSD * exp ( k * ( tx1 - t ) + h / ( 4.0 * Deff * ( tx1 - t ) ) ) ) / sqrt ( 4.0 * 4.0 * 4.0 * PI * PI * PI * Deff * Deff * Deff * ( t - tx1 ) * ( t - tx1 ) * ( t - tx1 ) ) ;
     if ( atp > c0cleft ) {
       atp = c0cleft ;
       }
