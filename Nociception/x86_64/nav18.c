...
#define nrn_init _nrn_init__nav18
#define _nrn_initial _nrn_initial__nav18
#define nrn_cur _nrn_cur__nav18
#define _nrn_current _nrn_current__nav18
#define nrn_jacob _nrn_jacob__nav18
#define nrn_state _nrn_state__nav18
#define _net_receive _net_receive__nav18 
#define states states__nav18 
...
extern Memb_func* memb_func;
 ...
 "setdata_nav18", _hoc_setdata,
 "alphas_nav18", _hoc_alphas,
 "alphah_nav18", _hoc_alphah,
 "alpham_nav18", _hoc_alpham,
 "betas_nav18", _hoc_betas,
 "betah_nav18", _hoc_betah,
 "betam_nav18", _hoc_betam,
 "rates_nav18", _hoc_rates,
 0, 0
};
#define alphas alphas_nav18
#define alphah alphah_nav18
#define alpham alpham_nav18
#define betas betas_nav18
#define betah betah_nav18
#define betam betam_nav18
#define rates rates_nav18
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 nav18 /Users/sulgod/rd/Nociception/x86_64/nav18.mod\n");
...
double alphas ( _threadargsprotocomma_ double _lVm ) {
   double _lalphas;
 _lalphas = 0.0001 * ( exp ( - ( _lVm + 8.0 ) / 29.0 ) ) + 0.0008 ;
...
double betas ( _threadargsprotocomma_ double _lVm ) {
   double _lbetas;
 _lbetas = 0.003 / ( 1.0 + 0.24 * exp ( - ( _lVm + 23.0 ) / 10.0 ) ) ;
