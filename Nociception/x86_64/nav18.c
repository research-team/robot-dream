...
double alpham ( _threadargsprotocomma_ double _lVm ) {
   double _lalpham;
 _lalpham = 7.35 - 7.35 / ( 1.0 + exp ( _lVm + 1.38 ) / 10.9 ) ;
...
double alphah ( _threadargsprotocomma_ double _lVm ) {
   double _lalphah;
 _lalphah = 0.011 + 1.39 / ( 1.0 + exp ( _lVm + 78.04 ) / 11.32 ) ;
...
double betam ( _threadargsprotocomma_ double _lVm ) {
   double _lbetam;
 _lbetam = 5.97 / ( 1.0 + exp ( _lVm + 56.43 ) / 18.26 ) ;
...
double betah ( _threadargsprotocomma_ double _lVm ) {
   double _lbetah;
 _lbetah = 0.56 - 0.56 / ( 1.0 + exp ( _lVm - 21.82 ) / 20.03 ) ;
