...
#define nrn_init _nrn_init__AtP_3
#define _nrn_initial _nrn_initial__AtP_3
#define nrn_cur _nrn_cur__AtP_3
#define _nrn_current _nrn_current__AtP_3
#define nrn_jacob _nrn_jacob__AtP_3
#define nrn_state _nrn_state__AtP_3
#define _net_receive _net_receive__AtP_3 
...
#define Deff _p[2]
#define rPSD _p[3]
#define meandist _p[4]
#define Popeak _p[5]
#define includir _p[6]
#define incluspill _p[7]
#define dir _p[8]
#define spill _p[9]
#define atp _p[10]
#define h _p[11]
#define Podir _p[12]
#define Pospill _p[13]
#define tx1 _p[14]
#define v _p[15]
#define _g _p[16]
#define _tsav _p[17]
...
#define a a_AtP_3
 double a = 0.02;
#define c0cleft_AtP_3 _thread1data[0]
#define c0cleft _thread[_gth]._pval[0]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 AtP_3 /Users/sulgod/rd/Nociception/x86_64/atp3.mod\n");
...
{
 {
   ...
   if ( t > tx1 ) {
     ...
     atp = ( 2.0 * c0cleft * PI * a * alpha * rPSD * rPSD * exp ( h / ( 4.0 * Deff * ( tx1 - t ) ) ) ) / sqrt ( 4.0 * 4.0 * 4.0 * PI * PI * PI * Deff * Deff * Deff * ( t - tx1 ) * ( t - tx1 ) * ( t - tx1 ) ) ;
     if ( atp > c0cleft ) {
       atp = c0cleft ;
       }
